...
const variants = {
  ...
  fill: { white_A700: "bg-white-A700 shadow-bs1 text-gray-800" },
};
...
const sizes = {
  ...
  lg: "pb-[11px] pt-[13px] px-[11px]",
  xl: "pb-[18px] pl-[18px] pr-3.5 pt-[19px]",
};
        ...
        <Select
          ...
          styles={{
            ...
            option: (provided, state) => ({
              ...
              "&:hover": { backgroundColor: "#ffffff", color: "#2d3748" },
            }),
