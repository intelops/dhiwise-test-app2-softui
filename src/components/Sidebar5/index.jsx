  ...
  return (
    <>
      <Sidebar className={props.className}>
        <Img
          className="h-3.5 mb-[1005px] ml-3.5 mr-[196px]"
          src="images/img_calculator_blue_gray_900_03.svg"
          alt="calculator"
        />
        <Text
          className="mb-[984px] ml-12 mr-[25px] mt-[21px] text-gray-800 text-xs"
        ...
        <Menu
          ...
          className="flex flex-col items-center justify-start mb-[269px] mt-[73px] pt-5 px-1.5 w-[94%]"
        >
        ...
        <div className="md:h-[1019px] h-[169px] ml-[15px] mt-[850px] relative w-[94%]">
          <Img
