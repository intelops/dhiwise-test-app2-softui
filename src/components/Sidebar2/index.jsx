  ...
  return (
    <>
      <Sidebar className={props.className}>
        <div className="flex flex-row gap-3 items-start justify-start mb-[981px] ml-3.5 mr-[25px] w-[83%]">
          <Img
        ...
        <Line className="bg-gradient18  h-px mb-[948px] mt-[54px] w-full" />
        <Menu
          menuItemStyles={{
            button: {
          ...
          className="flex flex-col items-center justify-start mb-[269px] mt-[57px] pt-5 px-1.5 w-[94%]"
        >
        ...
        <div className="md:h-[1003px] h-[169px] ml-[15px] mt-[834px] relative w-[94%]">
          <Img
