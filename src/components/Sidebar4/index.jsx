  ...
  return (
    <>
      <Sidebar className={props.className}>
        <Img
          className="h-[15px] mb-[1002px] ml-3.5 mr-[196px]"
          src="images/img_calculator_blue_gray_900_03.svg"
          alt="calculator"
        />
        <Text
          className="mb-[984px] ml-12 mr-[25px] mt-[19px] text-gray-800 text-xs"
        ...
        <Menu
          ...
          className="flex flex-col items-center justify-start mb-[269px] mt-[71px] pt-5 px-1.5 w-[94%]"
        >
        ...
        <div className="md:h-[1017px] h-[169px] ml-[15px] mt-[848px] relative w-[94%]">
          <Img
