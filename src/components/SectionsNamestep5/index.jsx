      ...
      <div className={props.className}>
        <div className="absolute sm:h-[116px] h-[42px] inset-y-[0] my-auto right-[0] w-[94%] md:w-full">
          <div className="flex sm:flex-col flex-row sm:gap-10 h-full items-start justify-between m-auto w-full">
            <Line className="bg-blue_gray-900 h-0.5 mb-8 sm:mt-0 mt-2 w-[31%]" />
            <div className="h-[42px] relative w-[35%] sm:w-full">
              <Line className="absolute bg-blue_gray-900 h-0.5 left-[0] top-[19%] w-[87%]" />
          ...
          <Line className="absolute bg-blue_gray-900 h-0.5 inset-x-[0] mx-auto top-[19%] w-[31%]" />
        </div>
...
SectionsNamestep5.defaultProps = {
...
export default SectionsNamestep5;
