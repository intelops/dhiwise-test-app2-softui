...
const ApplicationsWizzardThreePage = () => {
  const sideBarMenu = [
    {
      label: "Kanban",
        ...
        <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mb-8 mt-[9px] mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col md:gap-10 gap-[127px] items-center justify-start w-full">
            ...
            <div className="flex flex-col items-center justify-end w-full">
              ...
              <SectionsColumnSeven className="flex flex-col font-notosans gap-4 items-center justify-start mt-12 w-[55%] md:w-full" />
...
export default ApplicationsWizzardThreePage;
