...
const AuthenticationScreenError500Page = () => {
  return (
    <>
      <div className="bg-gray-100_01 flex flex-col font-notosans items-center justify-start mx-auto p-4 w-full">
        <div className="flex flex-col md:gap-10 gap-[73px] items-center justify-start max-w-[1568px] mx-auto md:px-5 w-full">
          <div className="flex flex-col md:gap-10 gap-[156px] items-center justify-start w-full">
            ...
            <div className="flex md:flex-col flex-row font-helvetica md:gap-10 items-center justify-between w-full">
              <div className="flex sm:flex-1 flex-col gap-8 items-start justify-center w-auto sm:w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-auto sm:w-full">
                  <Text
                    className="bg-clip-text bg-gradient9  md:text-5xl text-[80px] text-transparent tracking-[-0.80px] w-auto"
                    size="txtNotoSansBold80Yellow600"
                  >
                    Error 500
                  </Text>
                  <Text
              ...
              <Img
                className="h-[625px] md:h-auto object-cover"
                src="images/img_error4041_625x765.png"
                alt="error4041"
              />
            </div>
          </div>
...
export default AuthenticationScreenError500Page;
