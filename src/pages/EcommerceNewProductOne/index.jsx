...
const EcommerceNewProductOnePage = () => {
      ...
      <div className="flex flex-col font-helvetica items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          >
            ...
            <div className="h-[1305px] sm:h-[1360px] md:h-[951px] mr-1.5 md:mt-0 my-1.5 md:px-5 relative w-[86%] md:w-full">
              ...
              <div className="absolute flex flex-col md:gap-10 gap-[68px] inset-x-[0] items-center justify-start mx-auto top-[18%] w-[97%]">
                ...
                <div className="flex flex-col gap-[30px] items-start justify-start w-auto md:w-full">
                  <SectionsNamestep2 className="sm:h-[116px] md:h-[42px] h-[43px] relative w-full" />
                  <div
                    className="bg-cover bg-no-repeat bg-white-A700 flex flex-col h-[411px] items-end justify-start max-w-[931px] p-6 sm:px-5 rounded-[12px] w-full"
                    style={{
                      backgroundImage: "url('images/img_colorwhite.svg')",
                    }}
                  >
                    <div className="flex flex-col gap-7 items-start justify-start w-full">
                      <div className="flex flex-col font-notosans items-center justify-start">
                        <Text
                      ...
                      <div className="flex flex-col font-notosans gap-4 items-start justify-start w-full">
                        ...
                        <div className="flex md:flex-col flex-row gap-[30px] items-center justify-start w-full">
                          <div className="flex md:flex-1 flex-col gap-2 items-start justify-start w-[49%] md:w-full">
                            ...
                            <div className="bg-white-A700 border border-blue_gray-100 border-solid flex flex-col font-opensans gap-[11px] h-[127px] md:h-auto items-start justify-start pl-3.5 pt-[54px] rounded-lg w-[426px] sm:w-full">
                              <div className="flex flex-row gap-1 items-center justify-start w-[221px]">
                                <Text
                      ...
                      <Button
                        className="cursor-pointer font-bold font-helvetica h-10 leading-[normal] min-w-[83px] md:ml-[0] ml-[800px] text-[13px] text-center uppercase"
                        shape="round"
                        color="gray_900_05"
                        size="lg"
                        variant="fill"
...
export default EcommerceNewProductOnePage;
