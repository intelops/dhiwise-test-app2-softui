...
const EcommerceNewProductTwoPage = () => {
      ...
      <div className="flex flex-col font-helvetica items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          >
            ...
            <div className="h-[1305px] sm:h-[1360px] md:h-[502px] mr-1.5 md:mt-0 my-1.5 md:px-5 relative w-[86%] md:w-full">
              ...
              <div className="absolute flex flex-col md:gap-10 gap-[68px] inset-x-[0] items-center justify-start mx-auto top-[18%] w-[97%]">
                ...
                <div className="flex flex-col gap-[30px] items-start justify-start w-auto md:w-full">
                  <SectionsNamestep3 className="sm:h-[116px] md:h-[42px] h-[43px] relative w-full" />
                  <div
                    className="bg-cover bg-no-repeat flex flex-col h-[380px] items-end justify-start max-w-[931px] p-6 sm:px-5 w-full"
                    style={{
                    ...
                    <div className="flex flex-col items-start justify-start w-full">
                      <div className="flex flex-col items-center justify-start">
                        <Text
                          ...
                          size="txtHelveticaBold20Bluegray90003"
                        >
                          Media
                        </Text>
                      </div>
                      <div className="flex flex-col font-notosans items-center justify-start mt-8 w-full">
                        <div className="flex flex-col gap-2 items-start justify-start w-full">
                          ...
                          <div className="bg-white-A700 border border-blue_gray-100 border-solid flex flex-col h-[180px] md:h-auto items-center justify-center max-w-[883px] pl-3.5 rounded-lg w-full">
                      ...
                      <div className="flex flex-row font-helvetica sm:gap-10 items-center justify-between mt-[29px] w-full">
                        <Button
...
export default EcommerceNewProductTwoPage;
