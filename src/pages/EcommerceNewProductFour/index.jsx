...
const EcommerceNewProductFourPage = () => {
      ...
      <div className="flex flex-col font-helvetica items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          >
            ...
            <div className="h-[1305px] sm:h-[1360px] md:h-[831px] mr-1.5 md:mt-0 my-1.5 md:px-5 relative w-[86%] md:w-full">
              ...
              <div className="absolute flex flex-col md:gap-10 gap-[68px] inset-x-[0] items-center justify-start mx-auto top-[18%] w-[97%]">
                ...
                <div className="flex flex-col gap-10 items-start justify-start w-auto md:w-full">
                  <SectionsNamestep5 className="sm:h-[116px] md:h-[42px] h-[43px] pl-2 relative w-[95%] md:w-full" />
                  <div
                    className="bg-cover bg-no-repeat flex flex-col font-notosans h-[349px] items-end justify-start max-w-[931px] p-6 sm:px-5 w-full"
                    style={{
                  ...
                  >
                    <div className="flex flex-col items-start justify-start w-full">
                      ...
                      <div className="flex md:flex-col flex-row gap-6 items-start justify-start mt-[26px] w-full">
                        <GeneralInput
                      ...
                      <div className="flex flex-row font-helvetica sm:gap-10 items-center justify-between mt-[29px] w-full">
                        ...
                        <Button
                          className="cursor-pointer font-bold h-10 leading-[normal] min-w-[85px] text-[13px] text-center uppercase"
                          shape="round"
                          color="gray_900_05"
                          size="lg"
                          variant="fill"
...
export default EcommerceNewProductFourPage;
